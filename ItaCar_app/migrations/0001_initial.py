    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ItaCar_app.contacomum')),
            ],
        ),
        migrations.AddField(
            model_name='contacomum',
            name='idCliente',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ItaCar_app.pessoafisica'),
        ),
    ]
